...
namespace Kudu.Services.Web.App_Start
{
    public static class NinjectServices
    {
        ...
        public static void RegisterRoutes(IKernel kernel, RouteCollection routes)
        {
            ...
            routes.MapHttpWebJobsRoute("request-passthrough-continuous-job", "continuous", "/{jobName}/passthrough", new { controller = "Jobs", action = "RequestPassthrough" }, new { verb = new HttpMethodConstraint("GET", "HEAD", "PUT", "POST", "DELETE", "PATCH") });
